...
abstract class TPWebMessageListener {
  static List<TPWebMessageHandler> get messageHandler => [
        ...
        LocationHistoryMessageHandler(),
        LocationPermissionStatusMessageHandler(),
        LocationPermissionRequestMessageHandler(),
        LocationPermissionOpenSettingsMessageHandler(),
